...
<div class="wrapper max-1200 clearfix">
  ...
  <!-- <div class="tabs">
    <ul>
      ...
      <li class="clearfix"><h2 class="light" ><?php echo htmlspecialchars($cf['t2']->value); ?></h2></li>
      <li class="clearfix"><h2 class="light"><?php echo htmlspecialchars($cf['t3']->value); ?></h2></li>
      <li class="clearfix"><h2 class="light" ><?php echo htmlspecialchars($cf['t4']->value); ?></h2></li>
      <li class="clearfix"><h2 class="light" ><?php echo htmlspecialchars($cf['t5']->value); ?></h2></li>
      <li class="clearfix"><h2 class="light" ><?php echo htmlspecialchars($cf['t6']->value); ?></h2></li>
    </ul>
  </div>
