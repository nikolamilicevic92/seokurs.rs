 ...
 <div class="hero-container">
  ...
  <div class="max-1200 clearfix"> 
        <div class="o-nama clearfix">
            <div class="tabs">
            <ul>
                <li class="active"><h2 class="light">{{$cf['card_1_title']->value}}</h2></li>
                <li><h2 class="light">{{$cf['card_2_title']->value}}</h2></li>
                <li><h2 class="light">{{$cf['card_3_title']->value}}</h2></li>
                <li><h2 class="light">{{$cf['card_4_title']->value}}</h2></li>
                <li><h2 class="light">{{$cf['card_5_title']->value}}</h2></li>
                <li><h2 class="light">{{$cf['card_6_title']->value}}</h2></li>
            </ul>
            </div>
